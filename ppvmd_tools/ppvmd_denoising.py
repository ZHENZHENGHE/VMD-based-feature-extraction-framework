...
Physiology-preserving adaptive denoising for gastrointestinal pressure signals.

本文件只保留预处理/去噪主流程：
- hard physiological range gate
- local noise estimation
- physiological event detection
- morphology-aware artifact detection
- artifact reconstruction
- event-preserving adaptive smoothing

主要入口：
    physiology_preserving_adaptive_denoise
"""
...
# ============================================================
        ...
        # 只限制“新增扩展区域”不能进入生理事件区，
        # 同时保留原始检测到的 artifact。
        # ============================================================
        artifact_expanded = _expand_mask(artifact_raw, radius=1)
        artifact_raw = artifact_raw | (artifact_expanded & (~physio_mask_raw))
