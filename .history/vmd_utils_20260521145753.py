...
def compute_event_fidelity_metrics(
    n,
    time,
    reference,
    reconstructed,
    ...
    summary = {
        "Mean_Event_IoU": event_df["Event_IoU"].mean(),
        "Mean_PeakPreservationRatio": event_df["PeakPreservationRatio"].mean(),
        "Mean_AreaPreservationRatio": event_df["AreaPreservationRatio"].mean(),
...
# 1. 单次 VMD 参数评价函数
# ============================================================
from vmd_mode_scoring import summarize_physiology_vmd_result
from vmd_mode_scoring import physiology_constrained_vmd_reconstruction
